...
type User struct {
	ID              bson.ObjectID `json:"_id,omitempty" bson:"_id,omitempty"` // to auto-add ID when that field is empty in request
	...
	FavouriteGenres []Genre       `json:"favourite_genres" bson:"favourite_genres" validate:"required,dive"` // dive into Genre's tags and check it too
}
